Shader "ysShader/Distortion/distortion full effect" 
{
Properties {
	...
	_MaskTex ("遮罩(黑色及透明不显示)",2D) = "white" {}
	_RenderTex("相机视角图像(该物体不能被渲染)",2D) = "black" {}
...
{
	//noise effect
	half4 offsetColor1 = tex2D(_NoiseTex_v, i.uvmask + _Time.xz*_HeatTime_v);
    half4 offsetColor2 = tex2D(_NoiseTex_u, i.uvmask - _Time.zx*_HeatTime_u);
